...
public partial class MenubarSubContentCn : IAsyncDisposable
{
    ...
    [CascadingParameter] public MenubarSubCn? Sub { get; set; }
    [Inject] private JsInteropCn JsInterop { get; set; } = default!;

    private ElementReference _contentRef;
    private readonly string _id = $"menubar-sub-{Guid.NewGuid():N}";
    private readonly string _keyboardNavId = $"menubar-sub-kbd-{Guid.NewGuid():N}";
    private DotNetObjectReference<MenubarSubContentCn>? _dotnetRef;
