...
public partial class ContextMenuSubContentCn : IAsyncDisposable
{
    ...
    [CascadingParameter] public ContextMenuSubCn? Sub { get; set; }
    [Inject] private JsInteropCn JsInterop { get; set; } = default!;

    private ElementReference _contentRef;
    private readonly string _id = $"context-sub-{Guid.NewGuid():N}";
    private readonly string _keyboardNavId = $"context-sub-kbd-{Guid.NewGuid():N}";
    private DotNetObjectReference<ContextMenuSubContentCn>? _dotnetRef;
